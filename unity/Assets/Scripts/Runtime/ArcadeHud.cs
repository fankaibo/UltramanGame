    ...
    public sealed partial class ArenaController
    {
        void DrawArcadeHud()
        {
            ...
            if(!waiting&&!transforming&&!victory)
            {
                ...
                hud.Text(new Rect(486,22,308,28),"城市大决战",18,HudPainter.Ink,TextAnchor.MiddleCenter,true);
            ...
            if(waiting)
            {
                hud.Text(new Rect(345,53,590,67),"光之英雄 · 城市大决战",37,HudPainter.Ink,TextAnchor.MiddleCenter,true);
                hud.Text(new Rect(415,120,450,32),"这一次，由你守护城市",20,cyan,TextAnchor.MiddleCenter);
            ...
            {
                hud.Text(new Rect(330,67,620,68),"城市守护成功！",43,gold,TextAnchor.MiddleCenter,true);
