...
namespace UltramanGame.Runtime
{
    ...
    public sealed class VolcanoStage : MonoBehaviour
    {
        ...
        {
            // The photorealistic Fuji plate supplies the distant mountain. Keep
            // only a small 3D lava vent in front so no low-poly silhouette cuts
            // across the photographic horizon.
            GameWorld.Primitive("Lava vent",PrimitiveType.Cylinder,transform,p+Vector3.up*.035f,new Vector3(radius*.12f,.018f,radius*.12f),lava);
        }
