...
namespace UltramanGame.Editor
{
    [InitializeOnLoad] public static class ProjectSetup
    {
        ...
        public static void BuildMac()
        {
            ...
            foreach(var shader in new[]{"ContactShadow","ShadowSilhouette","CityGround","CitySky","DistrictBuilding","ImpactCloud","KaijuSurface","EnergyShield","EnergyFlare","CinematicComposite","TransformationVeil","SoftGlow","VolcanicPlume","StrikeRibbon","AshMote"})
