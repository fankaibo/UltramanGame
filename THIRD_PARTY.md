...
通过 Bing 找到的迪迦、哥尔赞商品照片作为外形参考，由内置 image_gen 制作八姿势战斗图集 `TigaActions.png`、`GolzaActions.png`。原始商品照片不包含在源码或游戏包中；角色动作插画包含在游戏资源中。它们是本项目生成的角色插画，并非官方游戏素材或影视录像。参考链接、提示词和渲染方式见 [角色造型参考](docs/角色造型参考.md)。迪迦、哥尔赞及相关角色权利仍属于原权利人，代码许可证不授予这些角色的权利。
